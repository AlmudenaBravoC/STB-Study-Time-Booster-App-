...
public class TasksAdapter {
    ...
    public static final String DATABASE_NAME = "STB";
    ...
    public TasksAdapter open() throws SQLException {
    ...
    public boolean updateNote(long rowId, String title, String body) { //add or modify the tasks
